...
export default function SignUpPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-bg-primary py-12 relative overflow-y-auto">
      ...
      <div className="w-full max-w-md p-8 glass-elevated rounded-2xl border border-border my-8">
          ...
          <div className="grid grid-cols-2 gap-3">
            <button
              ...
              className={`p-3 rounded-xl border text-sm transition-all flex flex-col items-center justify-center gap-1 ${
                role === "CLIENT"
                  ? "border-accent-primary bg-accent-primary/5 text-accent-primary font-medium ring-1 ring-accent-primary"
